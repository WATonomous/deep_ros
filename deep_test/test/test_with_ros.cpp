...
TEST_CASE_METHOD(deep_ros::test::TestExecutorFixture, "Multiple nodes with TestExecutorFixture", "[multi_node]")
{
  ...
  auto pub_node =
    std::make_shared<deep_ros::test::PublisherTestNode<std_msgs::msg::String>>(test_topic, "publisher_node");
  auto sub_node =
    std::make_shared<deep_ros::test::SubscriberTestNode<std_msgs::msg::String>>(test_topic, "subscriber_node");
