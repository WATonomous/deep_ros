...
def main():
    ...
    parser.add_argument("--input-names", type=str, default="input",
                       help="Comma-separated input names")
    parser.add_argument("--output-names", type=str, default="output",
                       help="Comma-separated output names")
    parser.add_argument("--opset", type=int, default=11,
                       help="ONNX opset version (default: 11)")
    parser.add_argument("--model-loader", type=str,
