...
def convert_transformers_to_onnx(model_name_or_path, output_path, 
                               task='default', opset=14):
...
def main():
    ...
    parser.add_argument("input", 
                       help="Model name (e.g., 'bert-base-uncased') or local path")
    ...
    parser.add_argument("--optimize", action="store_true",
                       help="Apply ONNX optimizations for inference")
    ...
    if args.optimize:
        ...
        try:
            ...
            print("Install onnxruntime-tools for optimization: pip install onnxruntime-tools")
