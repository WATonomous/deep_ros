...
def main():
    ...
    parser.add_argument("input", help="Input model path (SavedModel dir, .h5, or .tflite)")
    ...
    # Detect model format
    if os.path.isdir(args.input) and os.path.exists(os.path.join(args.input, "saved_model.pb")):
