 ...
 */
inline ImageEncoding get_image_encoding_info(const std::string & encoding)
{
 ...
 */
inline Tensor from_image(const sensor_msgs::msg::Image & image, bool normalize = false)
{
 ...
 */
inline sensor_msgs::msg::Image to_image(
 ...
 */
inline Tensor from_pointcloud2(const sensor_msgs::msg::PointCloud2 & cloud)
{
 ...
 */
inline Tensor from_laserscan(const sensor_msgs::msg::LaserScan & scan)
{
 ...
 */
inline Tensor from_imu(const sensor_msgs::msg::Imu & imu)
{
 ...
 */
inline Tensor from_image_batch(const std::vector<sensor_msgs::msg::Image> & images, bool normalize = false)
{
  if (images.empty()) {
